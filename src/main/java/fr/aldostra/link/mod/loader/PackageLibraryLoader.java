...
package fr.aldostra.link.mod.loader;
...
public class PackageLibraryLoader implements LibraryLoader {
    ...
    public LinkAPILibrary loadLibrary(String libraryName)
        ...
        if (unpackedLibDir != null && unpackedLibDir.exists()) {
            AldostraMumbleMumbleMumbleLinkImpl.LOG.info("Loading library '" + this.libraryName + "' from: " + unpackedLibDir.getAbsolutePath());
    ...
    private File unpackLibrary() {
        ...
        try {
            ...
            AldostraMumbleMumbleMumbleLinkImpl.LOG.warn("Problem extracting resource.", e);
            return null;
        }
    }
