...
import static net.minecraft.src.MumbleLink.ErrorHandler.ModError.*;
...
public class LibraryLoader {
    ...
    protected static ArrayList<UnsatisfiedLinkError> errors = new ArrayList<UnsatisfiedLinkError>();
    private ErrorHandler errorHandler;
    private Settings settings;

    public LibraryLoader(Settings settings) {
